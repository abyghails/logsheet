...
<head>
	...
	<title>Sistem Pencatatan Log (Log Sheet)</title>
	...
	<div class="app-container">
			...
			<nav class="nav-menu">
				...
				<div class="nav-group">
					...
					<div class="nav-submenu">
						<a href="log-sheet.php?cat=UTILITAS+HARIAN" class="nav-submenu-item">Utilitas Harian</a>
						<a href="log-sheet.php?cat=PUTM" class="nav-submenu-item">PUTM</a>
						<a href="log-sheet.php?cat=PUTR" class="nav-submenu-item">PUTR</a>
						<a href="log-sheet.php?cat=FIRE+PUMP" class="nav-submenu-item">Fire Pump</a>
						<a href="log-sheet.php?cat=GWT" class="nav-submenu-item">GWT</a>
						<a href="log-sheet.php?cat=ELEVATOR" class="nav-submenu-item">Elevator</a>
						<a href="log-sheet.php?cat=GENSET" class="nav-submenu-item">Genset</a>
						<a href="log-sheet.php?cat=GONDOLA" class="nav-submenu-item">Checklist Gondola</a>
					</div>
				</div>
				...
				<div class="nav-group">
					...
					<div class="nav-submenu">
						<a href="log-sheet.php?cat=SWMS" class="nav-submenu-item">SWMS</a>
					</div>
				<div class="nav-group">
					<div class="nav-item" style="cursor: pointer;">
						<div style="display:flex; align-items:center; gap:0.75rem;">
					...
					<div class="nav-submenu">
						<a href="log-sheet.php?cat=ESF" class="nav-submenu-item">Equipment Service Form (ESF)</a>
					</div>
				</div>
		...
		<main class="main-content">
			<header class="top-header">
				<div>
					<h1>Log Sheet Harian</h1>
					<p class="subtitle">Monitoring dan pencatatan aktivitas operasional sistem</p>
				</div>
			...
			<div class="stats-grid">
				<div class="stat-card">
					...
					<div class="stat-info">
						<h3>Total Pencatatan</h3>
						<p class="value">1,248</p>
						<p class="trend positive">↑ 12% dari bulan lalu</p>
					</div>
				</div>
				<div class="stat-card">
					...
					<div class="stat-info">
						...
						<p class="value">5</p>
						<p class="trend negative">Butuh pengecekan</p>
					</div>
				</div>
				<div class="stat-card">
					...
					<div class="stat-info">
						...
						<p class="value">1,130</p>
						<p class="trend positive">Sistem berjalan baik</p>
					</div>
				</div>
			</div>
			...
			<div class="table-container">
				<div class="table-header">
					<h2>Histori Terbaru (Google Sheet)</h2>
					<a href="log-sheet.php" style="text-decoration: none; font-size: 0.875rem; color: var(--primary); font-weight: 500;">Lihat Semua &rarr;</a>
				</div>
				...
				$jsonData = @file_get_contents($scriptUrl . "?action=getData" . $sheetParam);
				...
				if (!empty($rows)) {
					...
					$rows = array_slice($rows, 0, 5); // Tampilkan Max 5 di Dashboard
				}
				?>
				...
				<div class="table-responsive">
					<table class="log-table">
						<thead>
							<tr>
								<?php if (empty($headers)): ?>
									<th>Koneksi Google Sheet Gagal</th>
								<?php else: ?>
									<th>Tanggal</th>
									<th>Jam</th>
									<th>Engineering</th>
						...
						<tbody>
							<?php if (empty($rows)): ?>
								<tr>
									<td colspan="6" style="text-align: center; padding: 3rem;">Belum ada data di Spreadsheet.</td>
								</tr>
								<?php else:
								foreach ($rows as $row):
				...
				<div class="card-list">
					...
					?>
						...
						<div style="text-align: center; padding: 2rem; color: var(--text-muted);">Belum ada data.</div>
					<?php endif; ?>
				</div>
			</div>
		</main>
